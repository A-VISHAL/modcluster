  ...
  return [
    {
      ...
      title: 'Click here for free rewards',
      body: 'Check my promo site and follow the link now.',
      domain: 'bit.ly',
      subredditId,
      createdAt: now - 5 * 60 * 1000,
      accountAgeDays: 1,
      combinedKarma: 12,
      postFrequencyPerHour: 9,
      commentFrequencyPerHour: null,
      repeatedLinksCount: 4,
      repeatedDomainsCount: 3,
      suspiciousDomains: ['bit.ly'],
      suspiciousKeywords: ['free rewards', 'click here', 'promo'],
      toxicityScore: 0.08,
      crossSubredditActivityCount: 1,
      rapidPostBurstCount: 6,
    ...
    },
    {
      ...
      title: 'Re: moderator response',
      body: 'You are a traitor and should disappear. Kill yourself.',
      domain: 'reddit.com',
      subredditId,
      ...
      suspiciousDomains: [],
      suspiciousKeywords: ['traitor', 'kill yourself'],
      toxicityScore: 0.91,
      crossSubredditActivityCount: 4,
      rapidPostBurstCount: 3,
      banEvasionIndicators: true,
